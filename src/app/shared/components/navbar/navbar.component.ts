...
@Component({
  ...
  styles: [`
    .navbar {
      ...
      padding: 0 32px; height: 64px; background: #1E3A5F;
    ...
    .navbar__links a {
      ...
      padding: 6px 14px; border-radius: 6px; font-size: 0.88rem; transition: all 0.15s;
    }
    ...
    .navbar__avatar  {
      width: 36px; height: 36px; background: #2E75B6; border-radius: 50%;
    ...
    .navbar__logout {
      ...
      border-radius: 8px; color: rgba(255,255,255,0.85); font-size: 0.85rem;
      cursor: pointer; transition: all 0.15s;
    }
    .navbar__logout svg { width: 15px; height: 15px; }
    .navbar__logout:hover {
      background: rgba(220,50,50,0.3); border-color: rgba(220,50,50,0.5); color: white;
    }
  `]
})
